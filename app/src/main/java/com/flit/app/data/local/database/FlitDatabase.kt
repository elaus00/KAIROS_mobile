package com.flit.app.data.local.database
...
abstract class FlitDatabase : RoomDatabase() {
    ...
    companion object {
        const val DATABASE_NAME = "flit_database"

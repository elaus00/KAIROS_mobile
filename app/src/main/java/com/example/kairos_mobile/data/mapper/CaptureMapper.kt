...
class CaptureMapper @Inject constructor(
    ...
    fun toEntity(capture: Capture): CaptureQueueEntity {
        return CaptureQueueEntity(
            ...
            destinationPath = capture.classification?.destinationPath,
            ...
            metadata = capture.classification?.metadata?.let { gson.toJson(it) },
    ...
    fun toDomain(entity: CaptureQueueEntity): Capture {
        val classification = if (entity.classificationType != null) {
            Classification(
                type = CaptureType.valueOf(entity.classificationType),
        ...
        return Capture(
            ...
            source = CaptureSource.valueOf(entity.source),  // Phase 2

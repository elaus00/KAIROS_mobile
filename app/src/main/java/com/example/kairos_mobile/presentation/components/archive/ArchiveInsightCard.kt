package com.example.kairos_mobile.presentation.components.archive
...
/**
 * Archive 인사이트 카드 (확장/축소 가능)
 */
@Composable
fun ArchiveInsightCard(
    insight: Insight,
    isExpanded: Boolean,
    onToggleExpand: () -> Unit,
    onInsightClick: () -> Unit,
...
private fun TypeIcon(
    ...
    val icon = when (type) {
        ...
        InsightType.SCHEDULE -> Icons.Default.CalendarToday
...
/**
 * 시간 포맷팅 (HH:mm)
 * SimpleDateFormat을 캐싱하여 매번 새로 생성하지 않음
 */

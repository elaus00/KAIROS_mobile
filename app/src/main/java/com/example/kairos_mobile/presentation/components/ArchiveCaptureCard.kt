            ...
            Column(
                ...
                Button(
                    ...
                    colors = ButtonDefaults.buttonColors(
                        containerColor = PrimaryNavy.copy(alpha = 0.8f),
...
private fun SyncStatusBadge(
    ...
    val (text, color, icon) = when (syncStatus) {
        "SYNCED" -> Triple("동기화됨", androidx.compose.ui.graphics.Color(0xFF81C784), Icons.Default.CheckCircle)
        "PENDING" -> Triple("대기 중", androidx.compose.ui.graphics.Color(0xFFFFB74D), Icons.Default.Schedule)
        "FAILED" -> Triple("실패", androidx.compose.ui.graphics.Color(0xFFE57373), Icons.Default.Error)
        else -> Triple(syncStatus, TextTertiary, Icons.Default.Info)
    }
